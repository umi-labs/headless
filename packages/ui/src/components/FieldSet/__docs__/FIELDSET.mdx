...
import * as FIELDSET from "./FIELDSET.stories.tsx";

<Meta of={FIELDSET} title="FIELDSET" />

# FIELDSET

FIELDSET component with different props.

#### Example

<Canvas of={FIELDSET.Primary} />

## Usage

```ts
import {FIELDSET} from "sld-ui";
