...
export default function CardGridSideTitle({ data }: HeroWithMediaProps) {
  return (
    <section
      className={cn(
    ...
    >
      ...
      <div className="md:grid md:grid-cols-3 md:grid-rows-1 flex flex-col items-center justify-center w-full gap-10 md:gap-16 px-6 md:px-10 text-center relative z-10">
        ...
        <div
          className={cn(
            "grid grid-flow-row md:grid-cols-2 lg:grid-cols-3 items-center justify-center w-full gap-9 col-span-2",
          )}
        >
