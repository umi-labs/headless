      ...
      {data?.mainNav?.items && data.mainNav.items.length > 0 && (
        <>
          <button
            ...
            className={cn(
              'interactable bg-transparent z-[100] flex flex-col items-center justify-center lg:items-start lg:justify-start gap-[4px] w-8 p-4 transition-all duration-300 ease group',
              menu ? 'open' : 'closed',
            )}
          >
